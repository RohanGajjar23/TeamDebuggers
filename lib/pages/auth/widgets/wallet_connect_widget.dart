                    ...
                    child: Column(
                      children: [
                        ...
                        TextFormField(
                          ...
                          decoration:
                              TextFieldDeco.decoration("Enter Your Public Key")
                                  .copyWith(
                            suffixIcon: IconButton(
                              onPressed: () {
                                controller
                                    .showPubKey(!controller.showPubKey.value);
                                controller.update();
                              },
                        ...
                        TextFormField(
                          ...
                          decoration:
                              TextFieldDeco.decoration("Enter Your Private Key")
                                  .copyWith(
                            suffixIcon: IconButton(
                              onPressed: () {
                                controller
                                    .showPriKey(!controller.showPriKey.value);
                                controller.update();
                              },
